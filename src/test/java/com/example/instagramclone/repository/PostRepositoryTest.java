...
@Transactional
//@Rollback(value = true) // 테스트 종료 후 데이터를 초기상태로 원상복구
class PostRepositoryTest {
    ...
    @Test
    @DisplayName("피드를 3개 작성하고 피드 목록조회하면 리스트의 크기는 3일것이다.")
    void findAllTest() {
    ...
    @Test
    @DisplayName("피드를 하나 생성하고 해당 피드에 이미지를 2개 첨부했을 때 이미지 생성과 함께 해당 이미지 목록이 조회된다.")
